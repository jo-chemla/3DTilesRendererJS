...
export class ScreenSpaceNormalEffect extends Effect {
	...
	constructor( maskTexture, test, camera ) {
		...
		// But probably less compute intensive
		...
		super(
			...
			/* glsl */ `
				...
				void mainImage(const in vec4 inputColor, const in vec2 uv, const in float depth, out vec4 outputColor) {
					...
					// outputColor = vec4(test.g, test.r, test.b, 0.9);
			...
			`, {
				...
				uniforms: new Map( [
					...
					// [ 'test', new Uniform( test ) ],
					// [ 'testt', new Uniform( camera && camera.near ) ],
				...
				// uniforms: { 'maskTexture': new Uniform( maskTexture ) }

			}
		);
		// this.setTest( new Vector3() );
